...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\columnwidth]{Figures/TPM/signature.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\columnwidth]{Figures/TPM/internal.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\columnwidth]{Figures/TPM/createKey.png}
\end{figure}
