...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\columnwidth]{Figures/fileSystem/luksFct.png}
    \label{fig:luksFct}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\columnwidth]{Figures/fileSystem/luksCont.png}
    \label{fig:luksCont}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\columnwidth]{Figures/fileSystem/fileperm.png}
    \label{fig:fileperm}
\end{figure}
